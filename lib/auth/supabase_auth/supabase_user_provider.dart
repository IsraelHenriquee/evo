...
class EvolutionCursoSupabaseUser extends BaseAuthUser {
  EvolutionCursoSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> evolutionCursoSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = EvolutionCursoSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
