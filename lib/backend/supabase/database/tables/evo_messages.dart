...
class EvoMessagesTable extends SupabaseTable<EvoMessagesRow> {
  @override
  String get tableName => 'evo_messages';

  @override
  EvoMessagesRow createRow(Map<String, dynamic> data) => EvoMessagesRow(data);
}

class EvoMessagesRow extends SupabaseDataRow {
  EvoMessagesRow(super.data);

  @override
  SupabaseTable get table => EvoMessagesTable();
